...
<body>
		...
		<div class="information">
			<form:form action="insertrecord.htm" modelAttribute="record"
				method="POST">
				<h3 class="tt"><spring:message code="newrecord.${sessionScope.message}"/></h3>
				<div>
					<label class="lable"><spring:message code="global.Username" /></label>
					<form:input path="staff.name" class="input" />
				</div>
				<div>
					<form:hidden path="staff.id" class="input" />
				</div>
				<div>
					<label class="lable"><spring:message code="global.Reason" /></label>
					<form:input path="reason" class="input" />
				</div>
				<div>
					<label class="lable"><spring:message code="global.DateRecorded" /></label>
					<form:input path="date" class="input" />
				</div>
				<div>
					<form:hidden path="type" class="input" />
				</div>
				<div>
					<button name="btnInsertRecord" class="btn btn-default" id="save"><spring:message code="global.Save" /></button>
				</div>
			</form:form>
		</div>
		<hr>
			...
			<div class="noidungfooter">
				<div class="cot1">
					...
					<ul>
						...
						<li><a href="#"><spring:message
									code="global.SalaryPolicy" /></a></li>
					</ul>
					<div class="follow">
						<br>
						<h2>
							<spring:message code="global.Follow" />
						</h2>
